  ...
  return (
    <section className="py-16 bg-white page-section">
      <div className="container mx-auto px-4">
        <h2 className="coca-cola-font font-bold text-4xl text-center mb-12">FOR THE PLANET</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="coca-cola-font font-bold text-xl mb-4">RECYCLING INNOVATION</h3>
          ...
          >
            ...
            <h3 className="coca-cola-font font-bold text-xl mb-4">WATER STEWARDSHIP</h3>
          ...
          >
            ...
            <h3 className="coca-cola-font font-bold text-xl mb-4">CARBON FOOTPRINT</h3>
